...
public class WSSClient implements AutoCloseable {
    ...
    public void run(long runTimeInMillis) throws InterruptedException, URISyntaxException {
        ...
        while (router.isRunning() && (startTime + runTimeInMillis > System.currentTimeMillis())) {
