...
@Log4j2
public class MoveOrder implements Move {
    ...
    public MoveOrder(String orderNumber, BigDecimal rate) {
        this(new MoveAsJson(orderNumber, rate));
    }

    public MoveOrder(Json jsonSource) {
