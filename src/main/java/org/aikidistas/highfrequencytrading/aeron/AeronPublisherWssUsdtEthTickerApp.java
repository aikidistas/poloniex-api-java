...
import org.aikidistas.highfrequencytrading.aeron.wssmessagehandler.WssToAeronUsdtEthTickerMessageHandler;

import java.util.concurrent.TimeUnit;

@Log4j2
public class AeronPublisherWssUsdtEthTickerApp implements App {
    ...
    public static void main(String[] args) {
        App app = new AeronPublisherWssUsdtEthTickerApp();
        app.run();
    }
    ...
    public void run() {
        try {
            new AeronPublisherWssUsdtEthTickerApp().subscribe();
    ...
    public void subscribe() throws Exception {
        try (WSSClient wssClient = new WSSClient(ENDPOINT_URL);
            ...
            wssClient.addSubscription(PoloniexWSSSubscription.TICKER, new WssToAeronUsdtEthTickerMessageHandler(publication));
