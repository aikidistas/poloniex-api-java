...
import org.aikidistas.highfrequencytrading.aeron.aeronfragmenthandler.PrintAsciTickerMessageFragmentHandler;
 ...
 */
@Log4j2
public class AeronSubscriberTickerApp implements App {
    private static final int STREAM_ID = SampleConfiguration.STREAM_ID;
    private static final String CHANNEL = SampleConfiguration.CHANNEL;
    private static final int FRAGMENT_COUNT_LIMIT = SampleConfiguration.FRAGMENT_COUNT_LIMIT;

    private final Aeron.Context aeronContext = new Aeron.Context()
            .availableImageHandler(AeronSubscriberTickerApp::printAvailableImage)
            .unavailableImageHandler(AeronSubscriberTickerApp::printUnavailableImage);

    public static void main(final String[] args) {
        App app = new AeronSubscriberTickerApp();
        app.run();
    }
    ...
    public void run() {
        ...
        final FragmentHandler fragmentHandler = new PrintAsciTickerMessageFragmentHandler();
